                    ...
                    <form method="post" action="<?php echo URL;?>dashboard/updateCar/<?php echo $this->myCar['carid'];?>" enctype="multipart/form-data">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-4 p-3 mr-auto ml-auto text-center">
                                ...
                                <div id="image_contain">
                                    ...
                                    ?>
                                        <img id="image-upload" align="middle" class="img-square img-no-padding img-responsive"
                                        src="<?php echo 'data:image/jpeg;base64,' . base64_encode($this->myCar['car_image']); ?>" alt="Car Image"
                                        title=''/>
                                    <?php 
                                        }
                                    ?>
                        ...
                        <div class="form-row">
                            <div class="form-group col-sm-6 col-md-4 p-3 ">
                                ...
                                value="<?php echo $this->myCar['reg_num'];?>">
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-sm-12 col-md-4 p-3">
                                ...
                                value="<?php echo $this->myCar['make'];?>">
                            </div>
                            <div class="form-group col-sm-12 col-md-4 p-3">
                                <label for="model">Model</label>
                                <input type="text" class="form-control" name="model" id="model" placeholder="Model"
                                value="<?php echo $this->myCar['model'];?>">
                            </div>
                            <div class="form-group col-sm-12 col-md-4 p-3">
                                ...
                                value="<?php echo $this->myCar['model_year'];?>">
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-sm-6 col-md-4 p-3">
                                ...
                                value="<?php echo $this->myCar['color'];?>">
                            </div>
                        </div>
                        <!-- end colour -->
                        ...
                        <div class="form-row">
                            <div class="form-group col-sm-8 col-md-3 p-3">
                                ...
                                <input class="form-control" type="number" min="1" max="16" name="number_of_seats" id="number_of_seats" placeholder="1"
                                value="<?php echo $this->myCar['seats'];?>">
                            </div>
                        </div>
                        <!-- end number of seats -->
