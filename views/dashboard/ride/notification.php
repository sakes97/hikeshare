                            ...
                            <div id='card' class="animated fadeIn">
                                ...
                                <div id='lower-side'>
                                    <p id='notification_message'>
                                        Message user to discuss details of your trip.
                                    </p>
                                    <a href="#" id="contBtn">Message</a>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div id='card' class="animated fadeIn">
                                ...
                                <div id='lower-side'>
                                    <p id='notification_message'>
                                    Your offer has been made. Please wait prompty for user to respond to your offer.
                                    </p>
                                    <a href="<?php echo URL;?>dashboard/index" id="contBtn">Home</a>
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div id='card' class="animated fadeIn">
                            ...
                            <div id='lower-side'>
                                <p id='notification_message'>
                                    Please wait for driver to accept or decline your request. You will be notified shortly
                                </p>
                                <a href="<?php echo URL;?>dashboard/index" id="contBtn">Home</a>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div id='card' class="animated fadeIn">
                                ...
                                <div id='lower-side'>
                                    <p id='notification_message'>
                                        Offer accepted. You may message the driver to discuss matters of your trip
                                    </p>
                                    <a href="<?php echo URL;?>dashboard/index" id="contBtn">Home</a>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <div id='card' class="animated fadeIn">
                                        ...
                                        <div id='lower-side'>
                                            <p id='notification_message'>
                                                Request successful. Please wait for driver to respond
                                            </p>
                                            <a href="<?php echo URL;?>dashboard/index" id="contBtn">Home</a>
                                        </div>
                                    </div>
